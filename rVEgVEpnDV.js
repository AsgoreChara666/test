...
(() => {
    var e, t, i, n, o, r, s = {
            ...
            5975: (e, t, i) => {
                ...
                function r(e, t, i) {
                    var n, o, r, s, a, l, c, d, u, p, h, f, m = i[0],
                        g = i[1],
                        y = i[2];
                ...
                function a(e, t, i, o) {
                    var r, s, a, l, c, d, u, p, h, f, m, g, y, v, x, b, w, S, A, _, T, C, k, E, B = o[0],
                        P = o[1],
                        M = o[2],
                        R = Math.hypot(B, P, M);
                    return R < n.Ib ? null : (B *= R = 1 / R, P *= R, M *= R, r = Math.sin(i), a = 1 - (s = Math.cos(i)), l = t[0], c = t[1], d = t[2], u = t[3], p = t[4], h = t[5], f = t[6], m = t[7], g = t[8], y = t[9], v = t[10], x = t[11], b = B * B * a + s, w = P * B * a + M * r, S = M * B * a - P * r, A = B * P * a - M * r, _ = P * P * a + s, T = M * P * a + B * r, C = B * M * a + P * r, k = P * M * a - B * r, E = M * M * a + s, e[0] = l * b + p * w + g * S, e[1] = c * b + h * w + y * S, e[2] = d * b + f * w + v * S, e[3] = u * b + m * w + x * S, e[4] = l * A + p * _ + g * T, e[5] = c * A + h * _ + y * T, e[6] = d * A + f * _ + v * T, e[7] = u * A + m * _ + x * T, e[8] = l * C + p * k + g * E, e[9] = c * C + h * k + y * E, e[10] = d * C + f * k + v * E, e[11] = u * C + m * k + x * E, t !== e && (e[12] = t[12], e[13] = t[13], e[14] = t[14], e[15] = t[15]), e)
                }
                ...
                n = function() {
                    return function(e) {
                            ...
                            function() {
                                n._nextId = 0, n._seed = 0, n._nowStartTime = +new Date, n._warnedOnce = {}, n._decomp = null, n.extend = function(e, t) {
                                    ...
                                    for (var r = i; r < arguments.length; r++) {
                                        var s = arguments[r];
                                        if (s)
                                            for (var a in s) o && s[a] && s[a].constructor === Object ? e[a] && e[a].constructor !== Object ? e[a] = s[a] : (e[a] = e[a] || {}, n.extend(e[a], o, s[a])) : e[a] = s[a]
                                    }
                                    return e
                        ...
                        n.create = function(e, t) {
                            ...
                            for (var a = [], l = 0; l < e.length; l++) {
                                ...
                                if (0 !== p) {
                                    var h = o.normalise({
                                        ...
                                        x = i; - 1 === i && (x = 1.75 * Math.pow(p, .32)), (x = r.clamp(x, n, s)) % 2 == 1 && (x += 1);
                            ...
                            if (s < 3) return null;
                            for (t = 0; t < s; t++)
                                if (n = (t + 2) % s, o = (e[i = (t + 1) % s].x - e[t].x) * (e[n].y - e[i].y), (o -= (e[i].y - e[t].y) * (e[n].x - e[i].x)) < 0 ? r |= 1 : o > 0 && (r |= 2), 3 === r) return !1;
                            return 0 !== r || null
                        }, n.hull = function(e) {
                            var t, i, n = [],
                                r = [];
                        ...
                        n.create = function(e) {
                            ...
                            if (e.isModified = t, t && e.cache && (e.cache.allBodies = null, e.cache.allConstraints = null, e.cache.allComposites = null), i && e.parent && n.setModified(e.parent, t, i, o), o)
                            ...
                            if (-1 !== o && n.removeCompositeAt(e, o), i)
                            ...
                            if (i)
                                for (var o = 0; o < e.composites.length; o++) n.clear(e.composites[o], t, !0);
                        ...
                        ! function() {
                            ...
                            n.set = function(e, t, i) {
                                var o;
                                for (o in "string" == typeof t && (o = t, (t = {})[o] = i), t)
                                    if (Object.prototype.hasOwnProperty.call(t, o)) switch (i = t[o], o) {
                                        case "isStatic":
                                            n.setStatic(e, i);
                                            break;
                                        case "isSleeping":
                        ...
                        o = [], r = {
                            ...
                            for (l = 0; l < g; l++) {
                                var x = n[l],
                                    ...
                                    _ = S,
                                    T = A;
                                for (c = 1; c < d; c += 1)(a = t[c].x * b + t[c].y * w) > _ ? _ = a : a < S && (S = a);
                                for (c = 1; c < u; c += 1)(a = i[c].x * b + i[c].y * w) > T ? T = a : a < A && (A = a);
                                if ((o = (r = _ - A) < (s = T - S) ? r : s) < y && (y = o, v = l, o <= 0)) break
                            }
                        ...
                        n.rectangle = function(e, t, i, n, a) {
                            ...
                            for (h = Boolean(A && A.quickDecomp), n = n || {}, m = [], c = void 0 !== c && c, d = void 0 !== d ? d : .01, u = void 0 !== u ? u : 10, p = void 0 !== p ? p : .01, r.isArray(i[0]) || (i = [i]), w = 0; w < i.length; w += 1)
                                if (y = i[w], !(g = o.isConvex(y)) && !h && r.warnOnce("Bodies.fromVertices: Install the 'poly-decomp' library and use Common.setDecomp or provide 'decomp' as a global to decompose concave vertices."), g || !h) y = g ? o.clockwiseSort(y) : o.hull(y), m.push({
                                    position: {
                                        x: e,
                                        y: t
                                    },
                                    ...
                                    A.makeCCW(_), !1 !== d && A.removeCollinearPoints(_, d), !1 !== p && A.removeDuplicatePoints && A.removeDuplicatePoints(_, p);
                            ...
                            "undefined" != typeof window && (e = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame || function(e) {
                                ...
                                if (a.trigger(e, "beforeRender", A), e.currentBackground !== b && f(e, b), m.globalCompositeOperation = "source-in", m.fillStyle = "transparent", m.fillRect(0, 0, h.width, h.height), m.globalCompositeOperation = "source-over", g.hasBounds) {
                                    ...
                                    for (i = 0; i < x.length; i++) {
                                        var T = x[i],
                                            ...
                                            E = T.pointA,
                                            B = T.pointB;
                                        C && (E = l.add(C.position, T.pointA)), k && (B = l.add(k.position, T.pointB)), E && B && (s.contains(e.bounds, E) || s.contains(e.bounds, B)) && S.push(T)
                                    }
                                ...
                                for (var i = t, n = 0; n < e.length; n++) {
                                    ...
                                    if (r.render.visible && r.pointA && r.pointB) {
                                        var s, a, c = r.bodyA,
                                            d = r.bodyB;
                                        if (s = c ? l.add(c.position, r.pointA) : r.pointA, "pin" === r.render.type) i.beginPath(), i.arc(s.x, s.y, 3, 0, 2 * Math.PI), i.closePath();
                                        else {
                                            if (a = d ? l.add(d.position, r.pointB) : r.pointB, i.beginPath(), i.moveTo(s.x, s.y), "spring" === r.render.type)
                                                for (var u, p = l.sub(a, s), h = l.perp(l.normalise(p)), f = Math.ceil(o.clamp(r.length / 5, 12, 20)), m = 1; m < f; m += 1) u = m % 2 == 0 ? 1 : -1, i.lineTo(s.x + p.x * (m / f) + h.x * u * 4, s.y + p.y * (m / f) + h.y * u * 4);
                                            i.lineTo(a.x, a.y)
                                        }
                                        ...
                                        for (s = n.parts.length > 1 ? 1 : 0; s < n.parts.length; s++)
                                            if ((o = n.parts[s]).render.visible) {
                                                if (l.showSleeping && n.isSleeping ? a.globalAlpha = .5 * o.render.opacity : 1 !== o.render.opacity && (a.globalAlpha = o.render.opacity), o.render.sprite && o.render.sprite.texture && !l.wireframes) {
                                                    ...
                                                    if (o.circleRadius) a.beginPath(), a.arc(o.position.x, o.position.y, o.circleRadius, 0, 2 * Math.PI);
                                                    else {
                                        ...
                                        if (l.showAxes)
                                            for (r = d.length > 1 ? 1 : 0; r < d.length; r++)
                                                for (n = d[r], s = 0; s < n.axes.length; s++) {
                                                    ...
                                                    for (r = d.length > 1 ? 1 : 0; r < d.length; r++)
                                                        for (n = d[r], s = 0; s < n.axes.length; s++) a.moveTo(n.position.x, n.position.y), a.lineTo((n.vertices[0].x + n.vertices[n.vertices.length - 1].x) / 2, (n.vertices[0].y + n.vertices[n.vertices.length - 1].y) / 2)
                                }
                                ...
                                for (a.beginPath(), r = 0; r < t.length; r++)
                                    if ((n = t[r]).render.visible)
                                        for (s = 0; s < n.parts.length; s++) o = n.parts[s], a.arc(o.position.x, o.position.y, 3, 0, 2 * Math.PI, !1), a.closePath();
                                ...
                                for (a.beginPath(), r = 0; r < t.length; r++)
                                    if ((n = t[r]).isActive)
                                        for (o = n.collision, s = 0; s < n.activeContacts.length; s++) {
                                ...
                                for (l.wireframes ? a.fillStyle = "rgba(255,255,255,0.7)" : a.fillStyle = "orange", a.fill(), a.beginPath(), r = 0; r < t.length; r++)
                                    if ((n = t[r]).isActive && (o = n.collision, n.activeContacts.length > 0)) {
                        ...
                        n.create = function(e) {
                            ...
                            for (a.update(g, S, v), e.enableSleeping && o.afterCollisions(g.list, y.timeScale), g.collisionStart.length > 0 && l.trigger(e, "collisionStart", {
                                    pairs: g.collisionStart
                                }), r.preSolvePosition(g.list), h = 0; h < e.positionIterations; h++) r.solvePosition(g.list, y.timeScale);
                            ...
                            }), n._bodiesClearForces(b), l.trigger(e, "afterUpdate", x), e.timing.lastElapsed = u.now() - p, e
                        ...
                        n._restingThresh = 4, n._restingThreshTangent = 6, n._positionDampen = .9, n._positionWarming = .8, n._frictionNormalMultiplier = 5, n.preSolvePosition = function(e) {
                            ...
                            var i, o, r, s, a, l, c, d, u = n._positionDampen,
                                p = e.length;
                            ...
                            var i, o, r, s, a = t * t,
                                l = n._restingThresh * a,
                                c = n._frictionNormalMultiplier,
                                d = n._restingThreshTangent * a,
                                u = Number.MAX_VALUE,
                                p = e.length;
                            for (r = 0; r < p; r++) {
                                var h = e[r];
                                if (h.isActive && !h.isSensor) {
                                    ...
                                    for (y.x = m.position.x - m.positionPrev.x, y.y = m.position.y - m.positionPrev.y, v.x = g.position.x - g.positionPrev.x, v.y = g.position.y - g.positionPrev.y, m.angularVelocity = m.angle - m.anglePrev, g.angularVelocity = g.angle - g.anglePrev, s = 0; s < _; s++) {
                                        var E = A[s],
                                            B = E.vertex,
                                            P = B.x - m.position.x,
                                            M = B.y - m.position.y,
                        ...
                        n.stack = function(e, t, i, n, r, s, l) {
                            ...
                            for (l = 0; l < i; l++) {
                                ...
                                if (l > 0)
                                    for (c = 0; c < t; c++) d = h[c + (l - 1) * t], u = h[c + l * t], o.addConstraint(e, r.create(s.extend({
                                        bodyA: d,
                                        bodyB: u
                        ...
                        n.create = function(e, t) {
                            ...
                            var i = e.mouse,
                                ...
                                s = e.body;
                            if (0 === i.button) {
                                if (n.bodyB) r.set(n.bodyB, !1), n.pointA = i.position;
                                else
                                    for (var c = 0; c < t.length; c++)
                                        if (s = t[c], p.contains(s.bounds, i.position) && l.canCollide(s.collisionFilter, e.collisionFilter))
                        ...
                        "undefined" != typeof window && (o = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame, r = window.cancelAnimationFrame || window.mozCancelAnimationFrame || window.webkitCancelAnimationFrame || window.msCancelAnimationFrame), o || (o = function(e) {
                            ...
                            return void 0 !== e.positionIterations && (t = e, e = n.create()),
                                function i(r) {
                        ...
                        n.pathToVertices = function(e, t) {
                            ...
                            for (var t, i, n, o, r, s, a = e.pathSegList, l = 0, c = 0, d = a.numberOfItems, u = 0; u < d; ++u) {
                                ...
                                else switch ("x1" in p && (n = l + p.x1), "x2" in p && (r = l + p.x2), "y1" in p && (o = c + p.y1), "y2" in p && (s = c + p.y2), "x" in p && (l += p.x), "y" in p && (c += p.y), h) {
                                    case "m":
            ...
            6472: (e, t, i) => {
                ...
                o.Ue(), o.al(1, 0, 0), o.al(0, 1, 0), l(), l(),
                    function() {
                        var e = new a.WT(9);
                        ...
                        if (this.conditionMap[this.currentState])
                            for (let e = 0; e < this.conditionMap[this.currentState].length; e++) {
                                const {
                                    nextState: t,
                                    condition: i
                                } = this.conditionMap[this.currentState][e];
                                if (i()) {
                                    this.changeState(t);
                                    break
                                }
                ...
                class S extends y {
                    ...
                    init(e) {
                        const t = e.gl;
                        this.renderer = e, this.shader = new g({
                            gl: t,
                            vs: b,
                            fs: w
                        });
                ...
                class k extends y {
                    ...
                    render(e) {
                        ...
                        if (C.time > this.lastChange + o.duration || this.changingAnimation) {
                            ...
                            this.shader.setUniform("half_pixel", "VEC2", s), this.lastChange = C.time
                        }
                    ...
                    try {
                        ...
                        class w {
                            ...
                            async init() {
                                ...
                                this.player = e, this.shamrocks = t, this.winds = i, this.birds = new m.g, this.countDown = new y.W, this.scene.addChild(new d.A), this.scene.addChild(this.birds), this.scene.addChild(t), this.scene.addChild(this.countDown), this.scene.addChild(e), this.scene.addChild(new h.o), this.scene.addChild(i), this.player = e, this.domElements.restartEl.onclick = () => {
                                ...
                                })), this.gameState.addHook("InGame", "leave", (() => {})), this.gameState.addHook("InGame", "update", (() => {
                                    ...
                                    i.pairs.forEach((i => {
                                        if (!e.lockGround && "groundSensor" === i.bodyA.label && 0 === i.bodyB.label.indexOf("leaf"))
                                            if (e.ground = i.bodyB, "leaf_trap" === i.bodyB.label) t.traps.find((e => e.leafBody === i.bodyB))?.triggerTrap(), (0, v.SZ)({
                                                type: "tech",
                                                c: "banner_game",
                                                d: "gaming",
                                                e: "trap"
                        ...
                        if (window.BannerGameSpring2022 = w, s.s1) {
                            ...
                            await e.init(), window.localStorage.getItem("banner_game_2022_spring") ? (e.gameContainer.focus(), e.start()) : (window.localStorage.setItem("banner_game_2022_spring", "1"), e.showGuide(), e.renderFirstFrame())
                        }
                        t()
                    } catch (e) {
                        t(e)
                    ...
                    r = e => {
                        ...
                        const A = [{
                            ...
                            if (i.classList.add("option-bubble"), Object.assign(i.style, {
                                    ...
                                    top: `${e.y}px`,
                                    left: "1186px"
                                }), i.innerHTML = e.text, 0 === t) i.style.paddingRight = "0px", i.style.paddingLeft = "16px";
                            else {
                                const t = document.createElement("div");
                        ...
                        return _.classList.add("score"), r.appendChild(_), {
                            bannerGame: t,
                            root: r,
                            canvas: a,
                            scoreEl: _,
            ...
            6010: (e, t, i) => {
                ...
                const f = new class {
                    ...
                    m = [
                        ...
                        ["身残志坚，答应22不要放弃治疗！", "这河狸吗？<br/>o(一︿一+)o  ", "是什么糊住了22的眼睛？是风！ ", "落地成盒，虾仁猪心 (ノへ￣、)"]
                    ],
                    g = {
                        timeText: m,
                    ...
                    update() {
                        if (o.XH.duration / 1e3 > this.nextAppear) {
                            ...
                            this.nextAppear = e + 30, this.genNumber(e).then((e => {
                                this.numNode.object?.destroy(), this.numNode.object = new n.jy({
                                    texture: e
                                }), this.birdNode.position = [1100, 75, -49], this.birdNode.object = this.birdSprite, this.birdSprite.lastChange = 0
                            }))
                        }
            ...
            5377: (e, t, i) => {
                ...
                const o = n.fF ? new Array(10).fill(0).map(((e, t) => ({
                    ...
                    r = (e, t, i, r = !1) => {
                        ...
                        const m = document.createElement("div");
                        m.classList.add("guide-arrow"), Object.assign(m.style, {
            ...
            1153: (e, t, i) => {
                ...
                class u extends n.BV {
                    ...
                    set position(e) {
                        super.position = e, o.Body.setPosition(this.body, {
                            x: e[0],
                            y: e[1]
                        })
                    }
                ...
                class f extends n.BV {
                    ...
                    constructor({
                        ...
                        this.state.addHook("entering", "enter", (() => {
                            ...
                            this._33.translate([4, -4, 0]), s.Body.translate(this.leafBody, {
                                x: l * n.HT.deltaT,
                                y: 0
                            })
                ...
                class l extends n.BV {
                    ...
                    update() {
                        if (n.HT.time > this.nextStart) {
                            const e = Math.floor((0, o.rs)([0, this.winds.length])),
                                t = this.winds[e];
            ...
            4634: (e, t, i) => {
                ...
                const a = async (e, t) => {
                    ...
                    await Promise.all([a("FZLanTYJW", s.fF ? "/FZLanTYJW.ttf" : "https://activity.hdslb.com/blackboard/static/20220310/00979505aec5edd6e5c2f8c096fa0f62/eg3s0Wl9p3.ttf"), a("HighPixel7", s.fF ? "/HighPixel7-08jv.ttf" : "https://activity.hdslb.com/blackboard/static/20220310/00979505aec5edd6e5c2f8c096fa0f62/cKILLYSZ6K.ttf")]), c = !0
                };
                let c = !1,
                    d = null;
                setTimeout((() => {
                ...
                const p = async (e, t) => {
                    ...
                    try {
                        const e = await (0, n.po)("https://i0.hdslb.com/bfs/activity-plat/static/20220317/00979505aec5edd6e5c2f8c096fa0f62/e0y0URDBAU.png");
                    ...
                    })), y.append(_), g.appendChild(y), document.body.appendChild(g);
                    const T = async () => {
                        ...
                        }, r.src = "https://www.bilibili.com/blackboard/fe/activity-Jxv8XB9Wcp.html?" + o.toString(), document.body.appendChild(r);
                        const a = e => {
                ...
                const s = e => e[0] + Math.random() * (e[1] - e[0]),
                    a = e => {
                        ...
                        return i.append("csrf", n || ""), i.append("bucket", "active"), i.append("file", e, "UPLOAD_IMG_" + +new Date + "." + (e => {
                            ...
                            return t[i] || i
                        })(e.type)), o().post("//api.bilibili.com/x/upload/web/image", i, {
                            withCredentials: !0
                        }).then((e => e.data?.data))
                    },
                    l = (e = {}, t = {}) => {
